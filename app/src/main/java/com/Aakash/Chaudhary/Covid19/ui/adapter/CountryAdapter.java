package com.Aakash.Chaudhary.Covid19.ui.adapter;
...
import com.Aakash.Chaudhary.Covid19.ui.activity.DetailActivity;
...
// The adapter prepare the layout of items by inflating the correct layout for individual data elements.
    @Override
    public CountryHolder onCreateViewHolder(ViewGroup parent,
     ...
     // Every visible entry in a recylcer view is filled with the correct data model item by the adapter. once a data
    // item becomes visible, the adapter assigns this data to the individual widgets which he infalted earlier.
    ...
    // total number of the input the adpater must return the total number of item
    @Override
